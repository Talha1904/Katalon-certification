...
WebUI.setText(findTestObject('Object Repository/9.2. click users tab/Page_Admin Panel/input_Email_email'), 'muhammad.talha@techwards.co')

WebUI.setEncryptedText(findTestObject('Object Repository/9.2. click users tab/Page_Admin Panel/input_Password_password'), 
    'Dpxl7+fjsHaPnN5Bh9tNqA==')

WebUI.click(findTestObject('Object Repository/9.2. click users tab/Page_Admin Panel/button_Sign in'))
